    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obra_social', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empleados', to='databaseManager.obrasocial')),
            ],
        ),
        migrations.CreateModel(
            name='Pedido',
            fields=[
                ...
                ('nombre_tarjeta', models.CharField(max_length=200, verbose_name='nombre de tarjeta de crédito')),
                ('numero_tarjeta', models.CharField(max_length=200)),
                ('vencimiento', models.DateField(verbose_name='fecha de vencimiento de tarjeta')),
        ...
        migrations.AddField(
            model_name='pedido',
            name='Servicio',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='databaseManager.servicioskillcode'),
        ),
    ]
